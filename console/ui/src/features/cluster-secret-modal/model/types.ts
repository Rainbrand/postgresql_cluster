...
import { LocalSecretFormValues, SecretFormValues } from '@entities/secret-form-block/model/types.ts';
...
interface ClusterLocalMachineProviderFormValues
  extends LocalSecretFormValues, LoadBalancersBlockValues, DatabaseServerBlockValues, DcsBlockFormValues {
