  ...
  return (
    <Box
      sx={{
        ...
        '&:hover': {
          borderColor: isActive ? theme.palette.primary.main : theme.palette.mode === 'light' ? '#3367D6' : '#5A8DEE',
          backgroundColor: theme.palette.mode === 'light' ? 'rgba(51, 103, 214, 0.02)' : 'rgba(90, 141, 238, 0.04)',
