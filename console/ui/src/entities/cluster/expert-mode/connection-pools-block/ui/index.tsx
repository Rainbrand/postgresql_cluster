...
import ConnectionPoolBox from '@entities/cluster/expert-mode/connection-pools-block/ui/ConnectionPoolBox.tsx';
import {
...
const ConnectionPoolsBlock: FC = () => {
  ...
  const watchIsConnectionPoolerEnabled = useWatch({
